...
const tools = [
  ...
  ['dc','D','機房負載概算','機櫃負載、散熱、耗電與三相電流'], ['heat','D','機房散熱評估','顯示散熱分項與來源'], ['power','D','預估用電容量 / NFB 估算','顯示供電容量分項與來源'], ['dc3','D','380V 三相電流概算','依kW、V、PF估算電流'],
